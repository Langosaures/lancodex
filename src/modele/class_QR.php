...
class QR{
    ...
    public function __construct($db){
        ...
        $this->select = $db->prepare("select q.id, q.libelle, t.logo, t.libelle, r.libelle from question q, technologie t, reponse r  where q.idTechnologie = t.id and q.idBonneReponse = r.id and q.id = :id");
    ...
    public function selectFausseRep($id){
        ...
        return $this->selectFausseRep->fetchAll();
    }
}
