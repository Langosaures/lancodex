...
(15, 'L\'éléphant code des pages Web dynamiques !', 3),
...
(56, 'Traiter des informations venant de la base de donn?es', 15),
...
(65, 'Exploiter des bases de donn?es', 18),
...
(71, 'python.png', 20),
(72, 'Apprendre à parler le fourchelang', 21),
...
(3, 'PHP', 'L\'Hypertext PreProcessor est un langage de programmation libre permettant de créer des pages Web dynamiques et fonctionnant avec la plupart des langages interprétés ( Javascript, HTML . . .)', 'php.png'),
...
(6, 'SQL', 'Le Structured Query Language est un langage informatique utilisé pour la gestion de base de données. Celui-ci envoie des requêtes à la base de données pour interagir avec ses informations.', 'sql.png'),
...
('test2@test.org', '$2y$10$SJ0fT47wQas0sfeV7JStBetaKqrZoQHqbVr5FQ0FxLnUYzwwlXzlu', '2', 'test'),
('test3@test3.org', '$2y$10$oEZbd01apifHuVhudHj0QuGTX9iseBQAtKDHuwdqum7cIZV7yfjY2', '2', 'Test'),
('test@test.org', '$2y$10$YlzNu3D.hfuslPYrijBzhexYp/koEJrYhLhSqlekO3n4JC7DSFeBG', '2', 'test');
